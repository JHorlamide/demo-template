...
const logData = [
	{
		...
		date: '28 Jan 2023',
		updateContent: [
			'[Update] Overall dependecies version',
			'[Replace] react-custom-scrollbars to react-custom-scrollbars-2',
			'[Replace] @vx/pattern to @visx/pattern',
		]
	},
	{
		version: '3.0.1',
